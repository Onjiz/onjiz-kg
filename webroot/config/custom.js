...
module.exports.custom = {
  ...
  BACKEND: {
    ...
    TAXONOMY: { //Danh sach taxonomy
      ID: 'taxonomy',
      URL: '/backend/taxonomy'
    },
    CATEGORY: { //Danh sach category
      ID: 'category',
      URL: '/backend/category'
    },
    PLAYLIST: { //Danh sach playlist
      ID: 'playlist',
  ...
  GOOGLE_PUBLIC_KEY: '6LfsfsMZAAAAAN4__OOd1FVTo6lFK7Y2sAyciXCk',
  GOOGLE_SECRET_KEY: '6LfsfsMZAAAAAFkSOpSHamG05Hik1NOnV7iAzqeu',
  SERVER: [{
      code: 's01',
      name: 'Server 01',
      ip: '10.10.10.10'
