  ...
  datastores: {
    ...
    ***************************************************************************/
    default: {
      ...
      ****************************************************************************/
      adapter: 'sails-mongo',
      host: process.env.MONGO_HOST || '127.0.0.1', // defaults to `localhost` if omitted 
      ...
      database: process.env.MONGO_DB_NAME || 'kindiedb1' // or omit if not relevant
    },
