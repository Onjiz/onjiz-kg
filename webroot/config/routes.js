...
module.exports.routes = Object.assign(routes_api_mobile.mobile, routes_api.api, routes_socket_mobile.socket, routes_frontend.frontend, {
...
//  'GET /installation/courseSession': { action: 'installation/coursesession', locals: { layout: 'installation/layouts/layout-installation' } },
 ...
 //==================================
  ...
  'GET /backend': { action: 'backend/dashboard/index', locals: { layout: 'backend/layouts/layout' } },
