...
const ErrorService = {
    ...
    EMAIL_IS_EXISTED: { code: 'EMAIL_IS_EXISTED', message: "Email người dùng đã tồn tại" },
    ...
    PARENT_ERR_USERNAME_REQUIRED: { code: 'PARENT_ERR_USERNAME_REQUIRED', message: "Tài khoản không được trống" },
    ...
    PARENT_ERR_USERNAME_PARENT_EXISTED: { code: 'PARENT_ERR_USERNAME_PARENT_EXISTED', message: "Tài khoản đã tồn tại" },
    ...
    //FEE ITEM
    FORMATION_ID_REQUIRED: { code: 'FORMATION_ID_REQUIRED', message: "Formation ID is required." },
    FORMATION_NAME_REQUIRED: { code: 'FORMATION_NAME_REQUIRED', message: "Formation name is required." },
    FORMATION_NOT_FOUND: { code: 'FORMATION_NOT_FOUND', message: "Formation is not found." },
