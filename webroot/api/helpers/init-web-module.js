  ...
  fn: async function (inputs, exits) {
    ...
    switch (inputs.req.options.action) {
      ...
      case 'backend/student/list':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.student && inputs.req.me.role.permissions.student.add)) {
          _default.actions = [{
      ...
      case 'backend/post/list':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.post && inputs.req.me.role.permissions.post.add)) {
          _default.actions = [
            {
      ...
      case 'backend/user/index':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.user && inputs.req.me.role.permissions.user.add)) {
          _default.actions = [{
              'title': sails.__('Add new'),
      ...
      case 'backend/coursesession/index':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.courseSession && inputs.req.me.role.permissions.courseSession.add)) {
          _default.actions = [{
              'title': sails.__('Add new'),
              'modal': '#modal-edit'
            }
      ...
      case 'backend/subject/index':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.subject && inputs.req.me.role.permissions.subject.add)) {
          _default.actions = [{
              'title': sails.__('Add new'),
              'modal': '#modal-edit'
          },
      ...
      case 'backend/food/index':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.food && inputs.req.me.role.permissions.food.add)) {
          _default.actions = [{
              'title': sails.__('Add new'),
              'modal': '#modal-edit'
          },
      ...
      case 'backend/branch/index':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.branch && inputs.req.me.role.permissions.branch.add)) {
          _default.actions = [{
              'title': sails.__('Add new'),
              'modal': '#modal-edit'
          }
      ...
      case 'backend/class/list':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.class && inputs.req.me.role.permissions.class.add)) {
          _default.actions = [{
              'title': sails.__('Add new'),
              'modal': '#modal-edit'
          }
      ...
      case 'backend/taxonomy/categories':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.taxonomy && inputs.req.me.role.permissions.taxonomy.add)) {
          _default.actions = [{
              'title': sails.__('Add new'),
              'modal': '#modal-edit'
            }
      ...
      case 'backend/notification/list':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.notification && inputs.req.me.role.permissions.notification.add)) {
          _default.actions = [{
              'title': sails.__('Add new'),
              'modal': '#modal-edit'
            }
      ...
      case 'backend/album/list':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.album && inputs.req.me.role.permissions.album.add)) {
          _default.actions = [{
              'title': sails.__('Add New'),
      ...
      case 'backend/parent/list':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.parent && inputs.req.me.role.permissions.parent.add)) {
          _default.actions = [{
              'title': sails.__('Add new'),
      ...
      case 'backend/schedule/index':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.schedule && inputs.req.me.role.permissions.schedule.add)) {
          _default.actions = [{
            'title': sails.__('Add new'),
            'modal': '#modalSchedule'
          },
      ...
      case 'backend/menu/index':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.menu && inputs.req.me.role.permissions.menu.add)) {
          _default.actions = [{
            'title': sails.__('Add new'),
            'modal': '#modalMenu'
          },
      ...
      case 'backend/currency/index':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.currency && inputs.req.me.role.permissions.currency.add)) {
          _default.actions = [{
              'title': sails.__('Add new'),
              'modal': '#modal-edit'
          }
      ...
      case 'backend/feeitem/index':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.feeItem && inputs.req.me.role.permissions.feeItem.add)) {
          _default.actions = [{
              'title': sails.__('Add new'),
              'modal': '#modal-edit'
          }
      ...
      case 'backend/feeinvoice/index':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.feeInvoice && inputs.req.me.role.permissions.feeInvoice.add)) {
          _default.actions = [
            {
              'title': sails.__('Add new'),
      ...
      case 'backend/event/list':
        ...
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.event && inputs.req.me.role.permissions.event.add)) {
          _default.actions = [{
              'title': sails.__('Add new'),
      ...
      case 'backend/medical/detail':
        ...
        if (inputs.req.params && inputs.req.params.id) {
          let medical = {};
          medical = await Medical.findOne({ id: inputs.req.params.id }).populate('classObj');
          if (medical && medical.classObj && medical.classObj.title) {
            _default.headline = sails.__('Medical Student') + ': ' + medical.classObj.title;
            _default.description = sails.__('Medical Student') + ': ' + medical.classObj.title;
          }
        }
        if (inputs.req.me.isMainSchoolAdmin) {
          _default.actions = [
      ...
      case 'backend/formation/index':
        _default.headline = sails.__('Formations');
        _default.description = sails.__('Formations');
        if (inputs.req.me.isMainSchoolAdmin || (inputs.req.me.role && inputs.req.me.role.permissions && inputs.req.me.role.permissions.formation && inputs.req.me.role.permissions.formation.add)) {
          _default.actions = [{
              'title': sails.__('Add new'),
              'modal': '#modal-edit'
          }
